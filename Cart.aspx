...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="pt-2 d-flex mt-5 justify-content-between" style="padding: 12rem">
        <asp:Repeater ID="rptCarrello" runat="server">
            <ItemTemplate>
                <div class="card me-2" style="flex-basis: 65%; height: 6rem">
        ...
        <div class="card">
            <div class="list-group list-group-flush">
                <ul class="p-0 mb-0">
                    ...
                    <li class="list-group-item">Have a coupon?</li>
                </ul>
            </div>
        </div>
